...
describe("Given the fucntion createKingCharacter", () => {
  describe("When it reciebes the name Marcos, the surname Rodríguez, the age 29, and the years reigning 2", () => {
    test.only("Then it should return a 29 years old King called Marcos Rodríguez, who has been reignin for 2 years", () => {
      const name = "Marcos";
  ...
  describe("When it recibes the name Marcos, the surname Rodríguez, the  age of 0, and the years reigning 0", () => {
